...
<!-- MAIN CONTENT / DASHBOARD INAPP -->
<div class="row">
  <div class="col-12">
    <div class="mb-4">
      <h1 class="fs-3 mb-1">Dashboard</h1>
      <p class="text-secondary">Your main content goes here…</p>
    </div>
  </div>
</div>
...
<div class="row g-3">
    ...
    <div class="card h-100">
      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item d-flex align-items-center gap-3">
          <img src="assets/images/product-2.png" class="rounded" width="48" alt="">
        ...
        <li class="list-group-item d-flex align-items-center gap-3">
          <img src="assets/images/product-1.png" class="rounded" width="48" alt="">
          <div class="flex-grow-1">
        ...
        <li class="list-group-item d-flex align-items-center gap-3">
          <img src="assets/images/product-3.png" class="rounded" width="48" alt="">
          <div class="flex-grow-1">
        ...
        <li class="list-group-item d-flex align-items-center gap-3">
          <img src="assets/images/product-4.png" class="rounded" width="48" alt="">
          <div class="flex-grow-1">
        ...
        <li class="list-group-item d-flex align-items-center gap-3">
          <img src="assets/images/product-5.png" class="rounded" width="48" alt="">
          <div class="flex-grow-1">
  ...
  <div class="col-lg-4">
    <div class="card h-100">
      <div class="card-header bg-white d-flex justify-content-between align-items-center px-4 py-3">
        ...
        <a href="index.php?action=index" class="small text-primary text-decoration-underline">View All</a>
      </div>

      <ul class="list-group list-group-flush">
        <li class="list-group-item d-flex align-items-center gap-3">
          <img src="assets/images/product-8.png" class="rounded" width="48" alt="">
          <div class="flex-grow-1">
            <p class="mb-1">Wireless Headphones</p>
            <small class="text-muted">ID: #554433</small>
          </div>
        ...
        <li class="list-group-item d-flex align-items-center gap-3">
          ...
          <div class="flex-grow-1">
            ...
            <small class="text-muted">ID: #887766</small>
          </div>
          <div class="d-flex flex-column gap-0 align-items-center">
        ...
        <li class="list-group-item d-flex align-items-center gap-3">
          <img src="assets/images/product-10.png" class="rounded" width="48" alt="">
          <div class="flex-grow-1">
            <p class="mb-1">Phone Screen Protector</p>
            <small class="text-muted">ID: #332211</small>
          </div>
          <div class="d-flex flex-column gap-0 align-items-center">
        ...
        <li class="list-group-item d-flex align-items-center gap-3">
          ...
          <div class="flex-grow-1">
            ...
            <small class="text-muted">ID: #998877</small>
          </div>
          <div class="d-flex flex-column gap-0 align-items-center">
        ...
        <li class="list-group-item d-flex align-items-center gap-3">
          <img src="assets/images/product-6.png" class="rounded" width="48" alt="">
          <div class="flex-grow-1">
            <p class="mb-1">Mechanical Keyboard RGB</p>
            <small class="text-muted">ID: #665544</small>
          </div>
          <div class="d-flex flex-column gap-0 align-items-center">
  ...
  <div class="col-lg-4">
    <div class="card h-100">
      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item d-flex align-items-center gap-3">
          <img src="assets/images/product-7.png" class="rounded" width="48" alt="">
          <div class="flex-grow-1">
        ...
        <li class="list-group-item d-flex align-items-center gap-3">
          <img src="assets/images/product-9.png" class="rounded" width="48" alt="">
          <div class="flex-grow-1">
