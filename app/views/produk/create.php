        ...
        <form action="index.php?action=store" method="POST">
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="nama_produk" name="nama_produk" placeholder="Contoh: Beras Ramos 5kg / Minyak Goreng" required>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" id="harga" name="harga" min="0" placeholder="0" required>
              </div>
            </div>
